        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(170px,1fr))', gap: 38, paddingTop: 44, borderTop: '1px solid rgba(240,237,232,.09)' }}>
          ...
          <div>
            ...
            {[
              ...
              <Link key={l.href} href={l.href} style={{ display: 'block', fontSize: 13, color: 'rgba(240,237,232,.5)', textDecoration: 'none', padding: '4px 0', transition: 'color .2s' }}
                onMouseEnter={e => (e.currentTarget.style.color = 'rgba(240,237,232,.88)')}
                onMouseLeave={e => (e.currentTarget.style.color = 'rgba(240,237,232,.5)')}>
                {l.label}
              </Link>
            ))}
          </div>
