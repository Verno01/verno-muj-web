...
export const metadata: Metadata = {
  ...
  description: 'Tvorba prezentačních webů pro živnostníky a malé firmy za pevnou cenu 8 900 Kč bez DPH. Plnohodnotný firemní web, mobilní verze, základní SEO a spuštění.',
