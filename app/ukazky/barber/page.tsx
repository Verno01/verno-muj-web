...
export const metadata: Metadata = {
  ...
  description: 'Ukázka webu pro barber shop: střihy, vousy, ceník, barbeři, práce, provozovna, kontakt a objednání.',
  ...
  return (
    <div className="br5" id="top">
      <style>{`
        ...
        .br5Booking{background:var(--paper);color:#111;padding:34px 0 38px;border-top:1px solid #111}.br5BookingIn{display:grid;grid-template-columns:.46fr 1.54fr;gap:44px;align-items:center}.br5BookingTitle{font-size:clamp(34px,3.8vw,52px);font-weight:900;letter-spacing:-.065em;line-height:.88}.br5BookingTitle small{display:block;font-size:10px;line-height:1.5;letter-spacing:0;font-weight:500;margin-top:10px;color:#555;max-width:260px}.br5BookFlow{display:grid;grid-template-columns:1fr 1fr 1fr auto;border-top:1px solid #111;border-bottom:1px solid #111}.br5BookCell{padding:13px 16px;border-right:1px solid #111}.br5BookCell small{display:block;font-size:8px;text-transform:uppercase;letter-spacing:.11em;color:#666;margin-bottom:7px}.br5BookCell strong{font-size:12px}.br5BookButton{border:0;background:#111;color:#fff;padding:0 20px;font-size:9.5px;font-weight:900;display:flex;align-items:center;justify-content:center;gap:8px}.br5BookAlt{margin-top:10px;font-size:10px;color:#555;display:flex;gap:18px;flex-wrap:wrap}.br5BookAlt strong{color:#111}.br5BookHint{margin-top:7px;font-size:8.5px;color:#888}
      ...
      <section className="br5People" id="barberi"><div className="br5Wrap"><div className="br5PeopleIntro"><h2>Barbeři.</h2><p>Při objednání si můžete vybrat konkrétního barbera, případně vzít první volný termín.</p></div><div className="br5PeopleCanvas">{barbers.map(([name,role,image])=><article className="br5Person" key={name}><div className="br5PersonPhoto"><img src={image} alt={`Barber ${name} při práci`}/></div><div className="br5PersonName">{name}</div><div className="br5PersonRole">{role}</div></article>)}</div></div></section>

      <section className="br5Shop" id="provozovna"><div className="br5ShopPhoto"><img src="https://images.pexels.com/photos/4625614/pexels-photo-4625614.jpeg?auto=compress&cs=tinysrgb&w=2200" alt="Interiér menšího barbershopu s pracovním křeslem"/></div><div className="br5Wrap br5ShopInfo"><div className="br5ShopName">Křeslo 39.</div><div><strong>Adresa</strong><br/>Tábor 39 · Brno–Žabovřesky</div><div><strong>Otevírací doba</strong><br/>Po–Pá 10:00–20:00<br/>So 9:00–15:00</div><div><strong>Objednání</strong><br/>777 000 000<br/>nebo online</div></div></section>

      <section className="br5Booking" id="objednani"><div className="br5Wrap br5BookingIn"><div className="br5BookingTitle">Objednání.<small>Termín můžete vybrat online nebo domluvit telefonicky.</small></div><div><div className="br5BookFlow"><div className="br5BookCell"><small>Služba</small><strong>Pánský střih</strong></div><div className="br5BookCell"><small>Barber</small><strong>Marek</strong></div><div className="br5BookCell"><small>Termín</small><strong>Úterý 25. 8. · 16:30</strong></div><button className="br5BookButton" type="button">Vybrat online <ArrowRight size={13}/></button></div><div className="br5BookAlt"><span><Phone size={12}/> Telefon: <strong>777 000 000</strong></span><span>Po–Pá 10:00–20:00 · So 9:00–15:00</span></div><div className="br5BookHint">Ukázkové online objednání není aktivní.</div></div></div></section>
