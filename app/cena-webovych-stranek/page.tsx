...
export default function WebsitePricePage() {
  ...
  return (
    <div className="pricePage">
      ...
      <section className="priceSection priceReal">
        <div className="priceWrap priceHead">
          <p className="priceLabel">Realizace</p>
          <h2>Weby, které už běží.</h2>
        </div>
        <div className="priceWrap priceReferences">
          <a href="https://rovino.cz" target="_blank" rel="noreferrer"><strong>Rovino</strong><span>Zemní práce</span><i>↗</i></a>
          <a href="https://5class.cz" target="_blank" rel="noreferrer"><strong>5class</strong><span>Osobní doprava</span><i>↗</i></a>
          <a href="https://www.petilista.cz" target="_blank" rel="noreferrer"><strong>Pětilistá</strong><span>Péče o hrobová místa</span><i>↗</i></a>
        </div>
      </section>
