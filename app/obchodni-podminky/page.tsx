...
export default function ObchodniPodminky() {
  return (
    ...
    >
      ...
      <p className="clause"><span className="clause-num">4.1.</span> Ceny zveřejněné na webu SpustWeb.cz jsou konečné ceny včetně DPH. Poskytovatel je plátcem DPH; daňový doklad obsahuje základ daně a DPH v zákonné sazbě platné ke dni uskutečnění zdanitelného plnění. U individuálně sjednávaných služeb je rozhodující cena odsouhlasená s klientem; není-li výslovně uvedeno jinak, je rovněž uvedena včetně DPH.</p>
